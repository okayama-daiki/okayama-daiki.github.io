...
{{% notice info %}}
This article is machine-translated from the [original Japanese version](/ja/posts/what-is-object/). If there is any discrepancy, the original Japanese content takes precedence.
{{% /notice %}}
